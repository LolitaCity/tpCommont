...
$maxAttachSize=40971520;//最大上传大小，默认是2M
$upExt='txt,rar,zip,jpg,jpeg,gif,png,swf,mp4,mov,rmvb,flv,mp3,mid';//上传扩展名
...
if($err==''){
	...
	if(preg_match('/^('.str_replace(',','|',$upExt).')$/i',$extension))
	{
		...
		else
		{
			...
			else $msg="{'url':'".'/ft_system/Application/Public/Admin/Dwz/xheditor/'.$targetPath."','localname':'".jsonString($localName)."','id':'1'}";//id参数固定不变，仅供演示，实际项目中可以是数据库ID
		}
	}
